...
- **Qualitative analysis:** supporting evidence on generation failures, noisy context and positional bias is available in `analysis/`.

## Notebooks, Reports and Slides

| Material | Link |
| --- | --- |
| HW1 notebook | [MNLP_HW1.ipynb](MNLP_HW1.ipynb) |
| HW2 notebook | [MNLP_HW2.ipynb](MNLP_HW2.ipynb) |
| HW1 report | [Sentence Embeddings](docs/MNLP_HW1_%20Report.pdf) |
| HW2 report | [Retrieval-Augmented Generation](docs/MNLP_HW2_Report.pdf) |
| Final slides | [From Dense Retrieval to Retrieval-Augmented Generation](docs/Serra_antonio_1893530_MNLP_slides.pdf) |
...
- `MNLP_HW1.ipynb` and `MNLP_HW2.ipynb`: project notebooks, including saved outputs.
- `docs/`: the two reports and final presentation in PDF format.
- `analysis/`: supporting qualitative-analysis text files.
